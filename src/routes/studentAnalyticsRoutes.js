...
router.get('/weak-areas', requireSubscription, StudentAnalyticsController.getWeakAreas);
router.get('/daily-stats', StudentAnalyticsController.getDailyStats);
router.get('/trends', requireSubscription, StudentAnalyticsController.getPerformanceTrend);
